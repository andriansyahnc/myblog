...
1. **Microservices Maintenance:** Actively managing over 10 backend microservices, utilizing Node.js, Laravel and Golang to ensure robust and scalable service architecture.
2. **Continuous Integration/Continuous Deployment (CI/CD):** Successfully migrated several backend microservices using CircleCI, Spinnaker, and Harness enhancing developer-based deployment processes.
