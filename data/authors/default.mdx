...
### **Backend Software Engineer** • [Keller Williams](https://www.kw.com)

**Aug 2020 - Present** • Remote (United States)

Maintaining and scaling **10+ production microservices** serving thousands of real estate agents:

- 🔄 **DevOps Excellence** - Migrated CI/CD pipelines to CircleCI, Spinnaker, and Harness, reducing deployment time by 60%
- 📬 **Asynchronous Processing** - Implemented Bull queue management and Google PubSub for reliable message handling
- 📊 **Observability** - Integrated Sentry error tracking and Datadog APM, improving incident response time by 70%
- ⚡ **Performance Optimization** - Optimized API response times and database queries for better user experience
- 🤝 **Cross-functional Collaboration** - Work closely with product managers and stakeholders on sprint planning and feature delivery
- 🏗️ **System Modernization** - Actively refactoring legacy services to modern architectures
...
- 🎯 **Perfect Delivery Record** - Achieved **100% on-time delivery** of all P0 deliverables across 11 months
- 📈 **Technical Excellence** - Enhanced team contribution to Technical Design Reviews by **150%** through mentorship and code review practices
- 🚀 **Problem Solver** - Unblocked cross-team dependencies and resolved critical technical issues that were blocking releases
- 💡 **Mentorship** - Coached engineers on microservices architecture, system design patterns, and best practices
- 🔧 **Code Quality** - Established engineering standards, improved test coverage, and championed technical debt reduction
- 📚 **Knowledge Sharing** - Conducted weekly tech talks and documentation sessions
